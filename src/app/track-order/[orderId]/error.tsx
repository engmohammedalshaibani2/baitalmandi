...
export default function TrackOrderError({ error, reset }: { error: Error; reset: () => void }) {
  console.error('[TRACK_ORDER_ERROR]', error.message, error.stack);
  return (
    <div className="container" style={{ paddingTop: '120px', paddingBottom: '80px', textAlign: 'center' }}>
      <div className="glass-panel" style={{ padding: '60px 40px', maxWidth: '500px', margin: '0 auto' }}>
        ...
        <h2 style={{ fontSize: '1.8rem', marginBottom: '15px' }}>عذراً، حدث خطأ في تحميل الطلب</h2>
        <p style={{ color: 'var(--text-secondary)', marginBottom: '30px' }}>
          لم نتمكن من تحميل بيانات الطلب. الرجاء المحاولة مرة أخرى.
        </p>
